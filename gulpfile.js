...
const config = {
	pluginSlug: 'kraftner-wp-torro-forms-submission-source',
	pluginName: 'Kraftner WP Torro Forms Submission Source',
	textDomain: 'kraftner-wp-torro-forms-submission-source',
